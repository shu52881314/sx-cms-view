<template>
  <section>
       ...
       <div>
           <el-form size='mini' label-width='12px'>
               <el-row>
                   ...
                   <el-col :span='3'>
                       <a class="el-button el-button--text el-button--mini" href='https://res.qutuo.net/download/template/%E5%AD%A6%E7%94%9F%E4%BC%9A%E6%A8%A1%E6%9D%BF.xlsx' size='mini' ><i class='el-icon-question'></i>模板下载</a>
                   </el-col>
               </el-row>
               ...
               <el-form-item label="" prop="name">
                 <el-col :span="22" >
                   <upload-file
                     ref="childUpload"
                     uploadUrl="/school/organization/union/import"
                     uploadType=".xls,.xlsx"
                     uploadSzie="100"
    ...
    <div style="float:right">
          <el-button type="primary" size="mini" @click="routerLink('club/edit', 'update', 0,'',3)" v-perms="'/organization/student-union/add'">添加</el-button>
          <el-button type="primary" size="mini" @click="dialogImportCollegeVisible = true" v-perms="'/organization/student-union/import'">导入</el-button>
		...
		<div class="main-body">
          ...
          <el-table-column  label="操作" width="220" align="center">
            <div slot-scope="scope">
              <!-- 可转载站点功能未完成 -->
              <el-button type="text" class="opreat-btn" @click.native="routerLink('club/edit','update',scope.row.id,'',3)">编辑</el-button>
              <el-button type="text" class="opreat-btn" @click.native="routerLink('club/detail', 'view', scope.row.id,'',3)">详情</el-button>
            </div>
          </el-table-column>
        </el-table>
