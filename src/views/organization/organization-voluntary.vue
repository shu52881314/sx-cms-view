            ...
            <el-form v-show="!fileList.length" size='mini' label-width='12px'>
                <div class="importTipsTitle">
                  ...
                  <span class="importTipsTitle-right">
                    <a class="el-button el-button--text el-button--mini" href='https://2class.oss-cn-shenzhen.aliyuncs.com/template/%E5%AD%A6%E7%94%9F%E7%BB%84%E7%BB%87%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF.xlsx' size='mini' ><i class='el-icon-question'></i>模板下载</a>
                  </span>
                </div>
...
<!--    </el-tabs>-->
    ...
    <div style="float:right" :class="{ isTopClass: ($root.ItemData && $root.ItemData.length && $root.ItemData.length == 1) }">
        <el-button  v-perms="'/organization/club/add'" type="primary" size="mini" @click="routerLink('club/edit', 'update', 0,'','','','',activeName)">添加</el-button>
