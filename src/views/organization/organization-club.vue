  ...
  <section>
          ...
          <el-form v-show="!fileList.length" size='mini' label-width='12px'>
            <div class="importTipsTitle">
              ...
              <span class="importTipsTitle-right">
                    <a class="el-button el-button--text el-button--mini" download="" href='/static/tpls/学生组织模板.xlsx'
    ...
    <div class="search-box" style="position:relative;">
      ...
      <div style="float:right"
           :class="{ isTopClass: ($root.ItemData && $root.ItemData.length && $root.ItemData.length == 1) }">
        <el-button v-perms="'/organization/club/add'" type="increase" size="mini"
                   @click="routerLink('club/edit', 'update', 0,'','','','',activeName)">添加
        </el-button>
        <el-button v-perms="'/organization/club/add'" type="primary" size="mini"
                   @click="dialogImportCollegeVisible = true">导入
        </el-button>
      </div>
    ...
    <div class="main-body">
      <el-table border :loading="loading" :data="data" stripe size="mini" style="width: 100%"
        ...
        <el-table-column width="130" show-overflow-tooltip prop="chairmanName" label="负责人"
                         align="center"></el-table-column>
        <el-table-column width="130" show-overflow-tooltip prop="guiderName" label="指导老师"
                         align="center"></el-table-column>
        <el-table-column width="160" show-overflow-tooltip prop="appenderName" label="挂靠单位"
                         align="center"></el-table-column>
        <el-table-column width="160" show-overflow-tooltip prop="parentName" label="上级机构"
                         align="center"></el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <div slot-scope="scope">
            ...
            <el-button type="text" class="opreat-btn"
                       @click.native="routerLink('club/edit','update',scope.row.id,'','','','',activeName)"
                       v-perms="'/organization/club/edit'">编辑
            </el-button>
            <el-button type="text" class="opreat-btn"
                       @click.native="routerLink('club/detail', 'view', scope.row.id,'',params.current,activeName)"
                       v-perms="'/organization/club/details'">详情
            </el-button>
            <el-button type="text" class="opreat-btn"
                       @click.native="deleteClub(scope.row.id,scope.row.organizationCount)"
                       v-perms="'/organization/club/delete'">删除
            </el-button>
          </div>
        </el-table-column>
      </el-table>
