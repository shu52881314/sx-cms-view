    ...
    <el-dialog title="导入"
     ...
     <el-tabs v-model="activeName" @tab-click="handleClick(activeName)">
      ...
      <span style="float:right">
						<el-button type="primary" size="mini" @click="routerLink('club/edit', 'update', 0,'',19)" v-perms="'/organization/other/add'">添加</el-button>
            <!--<el-button type="primary" size="mini" @click="dialogImportCollegeVisible = true" >导入</el-button>-->
		...
		<div class="main-body">
          ...
          <el-table-column  label="操作" width="220" align="center">
            <div slot-scope="scope">
              <!-- 可转载站点功能未完成 -->
              <el-button type="text" class="opreat-btn" @click.native="routerLink('club/edit','update',scope.row.id, '',19)" v-perms="'/organization/other/edit'">编辑</el-button>
              <el-button type="text" class="opreat-btn" @click.native="routerLink('club/detail', 'view', scope.row.id,'',19)" v-perms="'/organization/other/details'">详情</el-button>
            </div>
          </el-table-column>
        </el-table>
