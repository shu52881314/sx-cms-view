<template>
  <section>
	    ...
	    <el-dialog
		title="添加加分项" @close="beforeCloseHandler"
		:visible.sync="dialogVisible"
		:close-on-click-modal="false"
		width="650px">
		<div>
		<el-form  :model="ruleForm" :rules="rules"  ref="ruleForm" label-width="110px" class="demo-ruleForm">
			<el-form-item label="加分项名称" prop="name">
			<el-col :span="22" >
			 ...
			 <el-form-item label="选择分类" prop="parents">
				<el-col :span="22" >
					<el-cascader  style="width:100%"  class="selectWidth"   @change="handleChange" expand-trigger="hover" v-model="ruleForm.parents" clearable :options="options" :change-on-select="false" :show-all-levels="true"></el-cascader>
				</el-col>
			</el-form-item>
      <el-form-item label='限定类型' v-if='showLimit'>
        <el-col :span="22" >
          <el-select :disabled = 'selectAble' v-model="ruleForm.limitType" placeholder="请选择" >
			...
			<el-col :span="22" >
				<el-input maxlength="300" type="textarea"  :rows="2" v-model="ruleForm.des"></el-input>
			</el-col>
			</el-form-item>
			<el-form-item>
		...
		<div class="main-header" style="overflow: hidden;">
			<div style="width: 60%;float: left;">
				<p class="main-title" >加分项</p>
				<p style="font-size:12px;color:#999">学生有突出表现获得加分的，可进行添加或批量导入</p>
			</div>

			 <div style="width: 40%;float: right;">
					<el-button style='float: right;' @click="dialogVisible = true" type="increase" size="mini" >添加加分项</el-button>
			</div>
		</div>
		...
		<div class="main-body">
          ...
          <el-table-column prop="memberCount" label="加分人数"  show-overflow-tooltip>
          	<div slot-scope="scope">
          ...
          <el-table-column  label="操作"  >
            <div slot-scope="scope">
              <!-- 可转载站点功能未完成 -->
              <el-button type="text" class="opreat-btn" @click.native="routerLink('plus/detail','view',scope.row.id)" v-perms="'/communist/plus/detail'">详情</el-button>
              <el-button type="text" class="opreat-btn" v-if="scope.row.memberCount == 0" @click.native="deleteProject(scope.row.id)"v-perms="'/communist/plus/delete'">删除</el-button>
