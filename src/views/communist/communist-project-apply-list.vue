<template>
  <section>
    <el-tabs v-model="activeName" @tab-click="goTab">
      <el-tab-pane label="项目列表" name="0"></el-tab-pane>
    ...
    <div class="main-header">
      <span class="main-title">审核列表</span>
    ...
    <div class="search-box">
      <el-form size="mini" :inline="true" class="demo-form-inline">
        ...
        <el-form-item label="院系" prop="college">
          <el-col :span="22">
            <el-select clearable style="width:100%" v-model="params.collegeId" @change="changeCollege"
                       placeholder="请选择院系">
        ...
        <el-form-item label="专业" prop="major">
          <el-col :span="22">
            <el-select clearable style="width:100%" v-model="params.majorId" placeholder="请选择专业"
                       @change="changeMajor">
        ...
        <el-form-item label="班级" prop="class">
          <el-col :span="22">
            <el-select clearable style="width:100%" v-model="params.classId" placeholder="请选择班级"
        ...
        <el-form-item label="姓名">
          <el-input v-model="params.userName" maxlength=30 placeholder="请输入姓名搜索"></el-input>
        </el-form-item>

        <el-form-item label="学号">
          <el-input v-model="params.userCode" maxlength=30 placeholder="请输入学号搜索"></el-input>
        </el-form-item>

        <el-form-item label="项目名称">
          <el-input v-model="params.projectName" maxlength=30 placeholder="请输入项目名称"></el-input>
        </el-form-item>
    ...
    <div class="main-body">
      <el-table border :loading="loading" :data="data" stripe size="mini" style="width: 100%">
        ...
        <el-table-column prop="status" label="状态">
          <div slot-scope="scope">
            {{scope.row.status == 2 ? '待审核' : (scope.row.status == 1 ? '通过' : scope.row.status == 0 ? '驳回' : '未知状态')}}
          </div>
        </el-table-column>
        ...
        <el-table-column label="操作">
          <div slot-scope="scope">
            <!-- 可转载站点功能未完成 -->
            <router-link :to="'/communist/project/apply/detail?id=' + scope.row.userId + '&applyId=' + scope.row.applyId">
            ...
            <el-button type="text" class="opreat-btn" @click="rejectProject(scope.row.applId,scope.row.taskId)">驳回
            </el-button>-->
          </div>
        </el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      rejectProject(applId, taskId) {
        ...
        console.log(this.ruleFormReject.taskId)
      },
      //驳回提交
      submitFormReject() {
      ...
      fetch() {
        this.loading = true
        this.$http.get('/project/apply-list', {params: this.params}).then(res => {
      ...
      search() {
        ...
        if (this.time!=null){
          if (this.time.length) {
            this.params.btime = this.time[0].getTime();
            this.params.etime = this.time[1].getTime();
          } else {
            this.params.btimes = '';
            this.params.etimes = '';
          }
