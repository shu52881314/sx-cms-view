...
<div>
  ...
  <el-radio-group v-model="list.assignFirst" @change="changeType">
    <div class="radioPadding">
      <el-radio :label="1">上级机构</el-radio>
    </div>
    <div class="radioPadding">
  ...
  <div class="parentLine" v-if="list.assignFirst == 6">
    请选择指定组织成员类型：
  </div>

  <el-radio-group v-if="list.assignFirst == 6" v-model="list.assignSecond" style="padding-top:30px;">
    <div class="radioPadding">
  ...
  <div class="parentLine" v-if="isShow(list.assignFirst)">
    请选择上级机构成员类型：
  </div>

  <el-radio-group v-if="isShow(list.assignFirst)" v-model="list.assignSecond" style="padding-top:30px;">
    <div class="radioPadding">
      <el-radio :label="11">负责人</el-radio>
    </div>
    <div class="radioPadding">
