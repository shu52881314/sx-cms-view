<template>
  <section>
            ...
            <el-form v-show="!fileList.length" size='mini' label-width='12px'>
                <div class="importTipsTitle">
                  ...
                  <span class="importTipsTitle-right">
                    <a class="el-button el-button--text el-button--mini" href='https://2class.oss-cn-shenzhen.aliyuncs.com/template/%E5%9B%A2%E5%91%98%E7%BC%B4%E8%B4%B9%E6%A8%A1%E6%9D%BF%20.xlsx' size='mini' >模板下载</a>
                  </span>
                </div>
    ...
    <el-dialog :title="showMoney.userName + '的团费信息'" :visible.sync="dialogVisible" :close-on-click-modal="false" width="1000px">
        ...
        <div class="partyMoney-top">
           ...
           <div class="partyMoney-top-right" style='margin-left:0'>
             ...
             <p>归属团组织：{{showMoney.organizationName}}</p>
           </div>
        </div>
		...
		<div class="main-header">
			<span class="main-title">团费管理</span>
      <div class="main-btn-box">
        <el-button v-perms="'/ideology/group/fee/administration/import'" type="primary" size="mini"  @click="dialogImportCollegeVisible = true">导入缴费记录</el-button>
      </div>
		</div>
		...
		<div class="main-body">
          ...
          <el-table-column  label="操作" width="160" align="left">
            <div slot-scope="scope">
              <!-- 可转载站点功能未完成 -->
              <el-button v-perms="'/ideology/group/fee/administration/details'" type="text" class="opreat-btn" @click="showpartymoney(scope.row)">详情</el-button>
            </div>
          </el-table-column>
        </el-table>
