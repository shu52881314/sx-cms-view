...
<template>
	<section>
		...
		<el-dialog title='选择团员'  :visible.sync="dialogVisible" :close-on-click-modal="false" width="950px">
		...
		<div class="main-body">
          ...
          <el-form-item label="宣传图片" prop="logo">
					...
					<el-form-item>
						<el-button v-if="this.$route.query.nature == 1" type="primary" @click="onSubmit(false, 'form')">立即录入</el-button>
						<el-button :disabled="$store.state.sys.isClick" v-else type="primary" @click="onSubmit(false, 'form')">立即创建</el-button>
...
//				}
        this.saveDataInfo(state, ref, '/ideology/meeting/add',this.ruleForm,'/ideology/thematic/meeting');
      },
    },
