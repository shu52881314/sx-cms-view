  ...
  <section>
    ...
    <el-dialog title="申请信息" :visible.sync="dialogVisiblesee" :close-on-click-modal="false" width="750px">
		...
		<div class="main-header">
			<span class="main-title">党员申请</span>
		</div>
        ...
        <el-form-item label="状态">
				...
				<el-form-item label="名称">
					<el-input v-model="params.keyword" maxlength=30  placeholder="请输入姓名/党组织名称搜索"></el-input>
				</el-form-item>
		...
		<div class="main-body">
          ...
          <el-table-column  label="操作" align="center">
            <div slot-scope="scope">
              <!-- 可转载站点功能未完成 -->
              <span v-perms="'/ideology/party/member/apply/examine'">
              ...
              <el-button @click="seeReason(scope.row.auditRemark)" v-if="scope.row.status == 2" type="text" class="opreat-btn">查看通过理由</el-button>
