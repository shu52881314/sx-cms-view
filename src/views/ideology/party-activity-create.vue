                     ...
                     <el-col :span="22">
                         ...
                         <template>
                              <div v-show="activity.tribeIdLimit2 == 1">
                                <el-select @change="handleCheckedTribeChange" style="width:100%"   v-model="activity.tribeIdLimit3" multiple placeholder="请选择">
                                   <el-option
...
export default {
    ...
    methods: {
        getInfo(id){
            this.$http.get('/activity/detail', {params: {id:id}}).then(res => {
             ...
             this.activity.adminId = res.data.adminId
               ...
               this.activity.attachUrls2  = res.data.activityAttachment
       ...
       uploadSuccessed2(url) {
        ...
        handleDepartmentLimitChange(value){
          this.activitySuccess.voteDepartmentIdLimit = value
        },
        //参与年级选择
        // gradeStateChange(val) {
        //   this.activity.gradeLimit = val ? this.grades : [];
        // },
        ...
        //限制年级选择
        gradeLimitChange(val) {
          this.activitySuccess.voteGradeLimit = val ? this.grades : [];
        },
