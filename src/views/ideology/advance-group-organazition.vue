...
<section>
  ...
  <div class="main-header">
    <span class="main-title">先进团组织</span>
    <div class="main-btn-box">
      <el-button type="primary" v-perms="'/ideology/advanced/group/add'" @click="routerLink('party/edit', 'update',0,'','3')" size="mini">新增征集主题</el-button>
    </div>
  </div>
  ...
  <div class="main-body">
    <el-table :loading="loading" :data="data" stripe size="mini" style="width: 100%">
      ...
      <el-table-column label="操作" width="160" align="left">
        <div slot-scope="scope">
          <!-- 可转载站点功能未完成 -->
          <el-button type="text" class="opreat-btn" @click.native="routerLink('party/show','view',scope.row.id,'','3')">详情</el-button>
        </div>
      </el-table-column>
    </el-table>
