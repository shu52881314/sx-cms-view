<template>
  <section>
        ...
        <el-form size="mini" :rules="rules" label-width="60px" :model="ruleFormPass" ref="ruleFormPass" class="demo-ruleForm">
          ...
          <el-form-item prop="hours"  :label="hoursUnit">
              <el-col :span="22">
                  <el-input :placeholder="'请输入' + hoursUnit" v-model="ruleFormPass.hours"></el-input>
              </el-col>
          </el-form-item>
            <el-form-item>
		...
		<div class="main-header">
			<span class="main-title">初审活动</span>
		</div>
		...
		<div class="search-box">
			<el-form size="mini" :inline="true" class="demo-form-inline">
				...
				<el-form-item label="名称">
					<el-input v-model="params.activityName" placeholder="请输入名称搜索" maxlength=30 ></el-input>
				</el-form-item>
          ...
          <el-table-column  label="操作" width="160" align="center">
            <div slot-scope="scope">
              ...
              <el-button type="text" class="opreat-btn" @click.native="routerLink('/communist/activity/detail','view',scope.row.activityId)">详情</el-button>
               ...
               <el-button  v-perms="'/ideology/party/activity/examine/adopt'" type="text" class="opreat-btn" @click.native="adopt(scope.row)">通过</el-button>
               <el-button  v-perms="'/ideology/party/activity/examine/reject'"  type="text" class="opreat-btn"  @click="eject(scope.row.activityId)" >驳回</el-button>
