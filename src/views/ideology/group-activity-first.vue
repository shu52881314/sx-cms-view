		...
		<div class="main-body">
          ...
          <el-table-column  label="操作" width="160" align="center">
            <div slot-scope="scope">
              ...
              <el-button type="text" class="opreat-btn" @click.native="adopt(scope.row)" v-perms="'/ideology/group/activity/found/adpot'">通过</el-button>
              <el-button type="text" class="opreat-btn"  @click="eject(scope.row.activityId)" v-perms="'/ideology/group/activity/found/reject'">驳回</el-button>
            </div>
          </el-table-column>
        </el-table>
