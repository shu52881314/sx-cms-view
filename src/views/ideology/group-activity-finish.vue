		...
		<div class="main-body">
          ...
          <el-table-column  label="操作" width="160">
            <div slot-scope="scope">
              ...
              <el-button type="text" class="opreat-btn" @click.native="refuseAcitivity(scope.row.activityId)" v-perms="'/ideology/group/activity/grant/refuse'">拒绝</el-button>
              <el-button type="text" class="opreat-btn" @click.native="reJectAcitivity(scope.row.activityId)" v-perms="'/ideology/group/activity/grant/reject'">驳回</el-button>
            </div>
          </el-table-column>
        </el-table>
