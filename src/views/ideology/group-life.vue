...
<section>
  ...
  <el-dialog title="添加团员" @close="beforeCloseHandler" :visible.sync="dialogVisible" :close-on-click-modal="false" width="550px">
    ...
    <div>
      <el-form size="mini" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
        ...
        <el-form-item label="开始日期" prop="joinTime">
  ...
  <div class="main-header">
    <span class="main-title">团组织生活</span>
    <div class="main-btn-box">
      <el-button v-perms="'/ideology/thematic/meeting/add'" type="primary" size="mini" @click.native="routerLink('meeting/edit','update')">新增团组织生活</el-button>
      <el-button v-perms="'/ideology/thematic/meeting/entry'" type="primary" size="mini" @click.native="routerLink('meeting/edit','update', 0,'',1)">录入团组织生活</el-button>
    </div>
  </div>
  ...
  <div class="main-body">
    <el-table :loading="loading" :data="data" stripe size="mini" style="width: 100%">
      ...
      <el-table-column label="操作" width="160" align="left">
        <div slot-scope="scope">
          <!-- 可转载站点功能未完成 -->
          <el-button v-perms="'/ideology/thematic/meeting/details'" type="text" class="opreat-btn" @click.native="routerLink('/ideology/meeting/show','view',scope.row.id)">详情</el-button>
        </div>
      </el-table-column>
    </el-table>
