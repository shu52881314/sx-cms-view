		...
		<div class="main-body">
          ...
          <el-table-column  label="操作" width="160" align="center">
            <div slot-scope="scope">
              ...
              <el-button v-perms="'/ideology/party/activity/examine/second/adopt'" type="text" class="opreat-btn" @click.native="adopt(scope.row)" >通过</el-button>
              <el-button v-perms="'/ideology/party/activity/examine/second/reject'" type="text" class="opreat-btn"  @click="eject(scope.row.activityId)" >驳回</el-button>
            </div>
          </el-table-column>
        </el-table>
