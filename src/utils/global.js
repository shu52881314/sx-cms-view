...
export default {
    install(Vue, options) {
        ...
        Vue.prototype.routerLink = function () {
            ...
            params['nature'] = arguments[4] ? arguments[4] : 0;
            params['status'] = arguments[5] ? arguments[5] : 0;
            params['router'] = arguments[6] ? arguments[6] : '';
            params['activeName'] = arguments[7] ? arguments[7] : '';
